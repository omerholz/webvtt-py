...
class WebVTTTestCase(GenericParserTestCase):
    ...
    def test_captions_prevent_write(self):
        vtt = webvtt.read(self._get_file("sample.vtt"))
        self.assertRaises(AttributeError, setattr, vtt, "captions", [])
    ...
    def test_malformed_start_timestamp(self):
        self.assertRaises(webvtt.errors.MalformedCaptionError, Caption,
                          "01:00")
    ...
    def test_content_formatting(self):
        ...
        captions = [
            ...
            Caption(
                "00:00:08.000",
                "00:00:15.000",
                ["Caption test line 3", "Caption test line 4"],
            ),
        ]
